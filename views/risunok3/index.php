...
use yii\helpers\Url;
use app\models\vote\VoteRisunok3;
use app\assets\fancybox\FancyboxAsset;
FancyboxAsset::register($this);

$isUnlimited = VoteRisunok3::isUnlimited() ? 'true' : 'false';
...
<div class="vote-newyear-toy-index">
    ...
    <?php if (VoteRisunok3::showBtnVote()): ?>
    <div class="alert alert-info">
        <?php if (VoteRisunok3::isVoted()): ?>
        ...
        <div class="col-sm-12">
            <div class="panel panel-default">
                ...
                <div class="panel-footer">
                    ...
                    <hr /-->
                    <div class="btn-group">
                        <?php if (!VoteRisunok3::isVoted() && VoteRisunok3::showBtnVote()): ?>
                            <?= Html::button('Голосовать', ['class' => 'btn btn-primary btn-vote', 'data-href' => Url::to(['vote', 'id'=>$item->id])]) ?>
                        <?php endif; ?>

                        <?php if (VoteRisunok3::showBtnStatistic()): ?>
