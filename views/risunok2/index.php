...
use yii\helpers\Url;
use app\models\vote\VoteRisunok2;
use app\assets\fancybox\FancyboxAsset;
FancyboxAsset::register($this);

$isUnlimited = VoteRisunok2::isUnlimited() ? 'true' : 'false';
...
<div class="vote-newyear-toy-index">
    ...
    <?php if (VoteRisunok2::showBtnVote()): ?>
    <div class="alert alert-info">
        <?php if (VoteRisunok2::isVoted()): ?>
        ...
        <div class="col-sm-12">
            <div class="panel panel-default">
                ...
                <div class="panel-footer">
                    ...
                    <hr /-->
                    <div class="btn-group">
                        <?php if (!VoteRisunok2::isVoted() && VoteRisunok2::showBtnVote()): ?>
                            <?= Html::button('Голосовать', ['class' => 'btn btn-primary btn-vote', 'data-href' => Url::to(['vote', 'id'=>$item->id])]) ?>
                        <?php endif; ?>

                        <?php if (VoteRisunok2::showBtnStatistic()): ?>
