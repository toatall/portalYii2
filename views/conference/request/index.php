...
<div class="conference-request">
    ...
    <?= Html::a('Добавить заявку', ['/conference/request-create'], ['class' => 'btn btn-primary']) ?><br /><br />
                ...
                'value' => function($model) {
                    ...
                    switch ($model->status) {
                        ...
                        case AbstractConference::STATUS_DENIED: 
                            return '<span class="badge badge-danger fa-1x"><i class="fas fa-times"></i> Отказано</span>';       
                    }
            ...
            [
                ...
                'buttons' => [
                    'view' => function($url, $model) {
                        return Html::a('<i class="fas fa-eye"></i>', ['conference/view', 'id'=>$model->id], ['class' => 'mv-link']);
                    },
