...
/** @var array $data */
/** @var app\modules\paytaxes\models\PayTaxesChartDay[] $models */

?>

<div class="table-responsive">

    <?php Pjax::begin(['id' => 'pjax-pay-taxes-manage-chart-day', 'timeout' => false, 'enablePushState' => false]) ?>
    
    <?php $form = ActiveForm::begin([
        'id' => 'form-pay-taxes-manage-chart-day',
        'options' => [
            'data-pjax' => true,
        ],
    ]) ?>
