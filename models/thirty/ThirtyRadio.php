...
class ThirtyRadio extends \yii\db\ActiveRecord
{
    ...
    {
        return $this->hasMany(ThirtyRadioComment::className(), ['id_radio' => 'id']);
    }

    /**
     * Gets query for [[ThirtyRadioLikes]].
     *
     * @return \yii\db\ActiveQuery
     */
    public function getThirtyRadioLikes()
    {
        return $this->hasMany(ThirtyRadioLike::className(), ['id_radio' => 'id']);
    }

    /**
     * Gets query for [[ThirtyRadioVisits]].
     *
     * @return \yii\db\ActiveQuery
     */
    public function getThirtyRadioVisits()
    {
        return $this->hasMany(ThirtyRadioVisit::className(), ['id_radio' => 'id']);
    }
