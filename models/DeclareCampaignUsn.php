...
class DeclareCampaignUsn extends \yii\db\ActiveRecord
{
    ...
    public function attributeLabels()
    {
        return [
            ...
            'date' => 'Дата',
            'org_code' => 'Код НО',
            'count_np' => 'Количество НП (ед.)',            
            'count_np_provides_reliabe_declare' => 'Количество НП представивших верные Уведомления по УСН, либо уплативших УСН с кодом 02 (ед.)',
            'count_np_provides_not_required' => 'Количество НП, которым Уведомление представлять не требуется (ед.)',
            'deadline' => 'Срок уплаты',
            'accrued_sum' => 'Сумма начисленного налога по Уведомлениям, руб.',
        ];
    }
