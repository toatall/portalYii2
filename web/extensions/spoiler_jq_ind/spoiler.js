(function() {
    ...
    E.extend({
        ...
        className: {
            ...
            remove: function(c, b) {
                if (c.nodeType == 1) c.className = b != undefined ? E.grep(c.className.split(/\s+/),
                function(a) {
    ...
    E.event = {
        add: function(f, i, g, e) {
            ...
            handle = E.data(f, "handle") || E.data(f, "handle",
            function() {
                var a;
    ...
    function bindReady() {
        ...
        if (E.browser.opera) document.addEventListener("DOMContentLoaded",
        function() {
            if (E.isReady) return;
